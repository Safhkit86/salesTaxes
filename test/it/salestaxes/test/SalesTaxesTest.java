...
public class SalesTaxesTest {
	...
	//on exercise output example it was 6.70: maybe an error? 11.25*5% rounded
	//the nearest 0.05 is 0.55
	private static BigDecimal SALES_TAXES3 = new BigDecimal("6.65");
	//on exercise output example it was 74.68: maybe an error? 11.25*5% rounded
		//the nearest 0.05 is 0.55
